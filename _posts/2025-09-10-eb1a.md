...
<figure>
  <img src="{{ '/assets/img/green_card_stack.jpg' | relative_url }}" alt="A copy of my green card petition which I keep to this day. 1 gallon carton of milk included for reference." width="400">
  <figcaption>A copy of my green card petition (with 1 gallon of milk for scale)</figcaption>
</figure>
