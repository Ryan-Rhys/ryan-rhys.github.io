---
layout: post
title: EB1A Green Card - Self-Petitioning
...
**I AM NOT AN ATTORNEY.** This post describes my personal experience 
self-petitioning for an EB-1A green card in 2023. This is NOT legal 
advice and should NOT be used as a substitute for consultation with a 
qualified immigration attorney.

**What worked for me may not work for you.** Immigration law changes 
frequently, and every case is unique. **Consult with a licensed 
immigration attorney** before making any decisions about your immigration 
status.

I have NO liability for how you use this information. See full disclaimers 
in the [GitHub repository](https://github.com/Ryan-Rhys/EB1A).
═══════════════════════════════════════════════════════════════

## Overview

I successfully self-petitioned my own EB1A green card in 2023 without the assistance of immigration lawyers. My decision to do so was strongly influenced by [Razvan Marinescu's](https://razvanmarinescu.com/) experiences and his open-source [template](https://razvanmarinescu.github.io/green-card-I-140/) was an invaluable resource. I open-source my own template as an additional data point for the benefit of others undertaking the same process. All of my own materials can be found in the following GitHub [repo](https://github.com/Ryan-Rhys/EB1A).
...
To meet the standard for the EB1A green card, the applicant needs to satisfy three out of ten criteria set forth [here](https://www.uscis.gov/working-in-the-united-states/permanent-workers/employment-based-immigration-first-preference-eb-1). I ended up choosing four criteria:
...
<figure style="text-align:center;">
  ...
  <figcaption>A copy of my green card petition with a 1 gallon carton of milk included for scale.</figcaption>
</figure>
